...
**Related documentation:** Extend the ERTE core component with [EXTENDING.md](/workspace/docs/EXTENDING.md). Use I18n across your app with [CONTRIBUTING.md](/workspace/docs/CONTRIBUTING.md) patterns.
