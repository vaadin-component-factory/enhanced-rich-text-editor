package com.vaadin.componentfactory.helper;
...
public abstract class SpringDemoView extends Component
     ...
     *
     * @param heading    the header text of the card, that is added to the layout. If
     *                   <code>null</code> or empty, the header is not added
     * @param components components to add on creation. If <code>null</code> or empty,
     ...
     *
     * @param tabName    the name of the tab that will contain the demo, not
     *                   <code>null</code>
     * @param heading    the header text of the card, that is added to the layout. If
     *                   <code>null</code> or empty, the header is not added
     * @param components components to add on creation. If <code>null</code> or empty,
     ...
     * variants applied.
     *
     * @param componentSupplier  a method that creates the component to which variants will be
     *                           applied to
     * @param addVariant         a function that adds the new variant to the component
     * @param removeVariant      a function that removes the variant from the component
     * @param variantToThemeName function that converts variant to an html theme name
     * @param variants           list of variants to show in the demos
     * @param <T>                variants' type
     * @param <C>                component's type
     */
