...
| File | Action | What |
|------|--------|------|
| `enhanced-rich-text-editor/.../vcf-enhanced-rich-text-editor.js` | MODIFY | ReadOnlyBlot, protection, toolbar button, CSS, `__updateHtmlValue()` |
| `enhanced-rich-text-editor/.../RteExtensionBase.java` | MODIFY | `erteSanitize()`, `setPresentationValue()` override |
