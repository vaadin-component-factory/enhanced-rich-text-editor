# Phase 6.1: Aura Theme Support — Technical Analysis (Post-6.0.0)
...
> **Note:** ERTE 6.0.0 focuses on Lumo theme support only. Aura theme support is planned for a post-6.0.0 release (Phase 6.1).
...
**File:** `enhanced-rich-text-editor/src/main/resources/META-INF/resources/frontend/styles/erte-lumo-tokens.css`
...
**Start with Minimal approach** for initial Aura support. Full integration can be deferred to a later Phase 6 subphase or a future major version.
...
- **Phase 6.1:** Replace 4 tokens with generic `--vaadin-*` tokens, add `light-dark()` fallbacks for 5 custom tokens, document Aura setup in README
- **Phase 6.1 or later:** Full Aura integration with coordinated Vaadin platform PR
...
4. Update Phase 6.1 progress file with implementation tasks
