...
- `enhanced-rich-text-editor/src/main/resources/META-INF/resources/frontend/styles/vcf-enhanced-rich-text-editor-styles.css` — ERTE stylesheet (custom properties + all CSS rules)
- `enhanced-rich-text-editor/src/main/resources/META-INF/resources/frontend/vcf-enhanced-rich-text-editor.js` — JS component (imports CSS, simplified ruler/icon methods)
