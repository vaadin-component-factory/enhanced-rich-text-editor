...
**Status:** NOT STARTED
**Depends on:** 3.4j (Aura Theme Support)
...
- This phase must come AFTER 3.4j (Aura Theme Support) to ensure properties work with both Lumo and Aura
- Consider whether properties should be defined in the component JS or in separate theme files
- Some properties may need different defaults for Lumo vs Aura themes
