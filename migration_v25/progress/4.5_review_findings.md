...
**File:** `enhanced-rich-text-editor-tables-v25/src/main/java/.../events/TableSelectedEvent.java:44`
...
**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_GUIDE.md`
...
**File:** `enhanced-rich-text-editor-tables-v25/src/main/java/.../EnhancedRichTextEditorTables.java`
...
**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_UPGRADE_GUIDE.md:176`
...
**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_GUIDE.md` (Section 10, ~L706-729)
...
**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_GUIDE.md` (Section 5, ~L322-441)
...
**File:** `enhanced-rich-text-editor-tables-v25/src/main/java/.../EnhancedRichTextEditorTables.java:804`

**Problem:** "a the table border color" → "the table border color"

### 8. "Underscores OK" Claim Contradicts Regex

**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_UPGRADE_GUIDE.md:129`
...
**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_GUIDE.md:506`
...
**File:** `enhanced-rich-text-editor-tables-v25/docs/TABLES_GUIDE.md` (Section 6, ~L489-504)
...
**File:** `enhanced-rich-text-editor-tables-v25/README.md:65`
