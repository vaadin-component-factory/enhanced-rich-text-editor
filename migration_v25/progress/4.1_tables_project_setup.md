...
### POM Updates
- `enhanced-rich-text-editor-tables-v25/pom.xml`: Changed groupId from `org.vaadin.addons.componentfactory` to `com.vaadin.componentfactory`, added JUnit 5 + Mockito 5 test dependencies
- `enhanced-rich-text-editor-demo/pom.xml`: Added `enhanced-rich-text-editor-tables-v25` dependency
