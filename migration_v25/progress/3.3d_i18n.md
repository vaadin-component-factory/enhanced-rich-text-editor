...
## Files Changed
- `enhanced-rich-text-editor-v25/.../EnhancedRichTextEditor.java` — inner class
- `enhanced-rich-text-editor-v25/.../vcf-enhanced-rich-text-editor.js` — ERTE_I18N_DEFAULTS, setter, _applyErteI18n()
