...
1. **Configuration Classes**
   ...
   - **Template support** (V24 has "style template functionality" — predefine/modify/apply visual styles)
     - ⚠️ **SECURITY IMPLICATION:** Templates define user-defined CSS classes & styles
     - Core ERTE analysis: Template-based validation required (NOT static whitelist)
...
4. **Integration with ERTE Core**
   - **Sanitizer whitelist** (table elements)
     - ⚠️ **CRITICAL:** Template-based classes/styles must be allowed
