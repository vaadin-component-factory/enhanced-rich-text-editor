  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        __props.collapsed ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", _hoisted_1$1, [
        createBaseVNode("pre", _hoisted_2, [
          ...
          createBaseVNode("span", {
            class: normalizeClass(["message-body", `message-body-${__props.diagnostic.level}`])
          }, toDisplayString(__props.diagnostic.message), 3),
        ...
        hasFrame.value ? (openBlock(), createElementBlock("pre", _hoisted_4, [
          createBaseVNode("code", _hoisted_5, toDisplayString(__props.diagnostic.frame), 1)
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ul", null, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.diagnostics, (d) => {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ul", {
        style: normalizeStyle(__props.ulStyle)
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.checkerResults, (checkerResult, index) => {
