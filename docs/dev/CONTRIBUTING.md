...
Contributions require: [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md) for setup, [User Guide](../user/USER_GUIDE.md) for end-user features.
...
- ✅ Tests cover feature
- ✅ Documentation updated ([USER_GUIDE.md](../user/USER_GUIDE.md) or [API_REFERENCE.md](../user/API_REFERENCE.md))

---

**See also:** [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md), [USER_GUIDE.md](../user/USER_GUIDE.md), [API_REFERENCE.md](../user/API_REFERENCE.md), [CLAUDE.md](../../CLAUDE.md)
