/**
 * ERTE v25 - Extra SVG Iconset
 *
 * Registers a <vaadin-iconset> with ERTE-specific SVG icons.
 * These are used by ERTE's Java API for icon components in the toolbar
 * (e.g., table operations, alignment, indentation, whitespace toggle).
 *
 * Usage in Java: new Icon("vcf-erte-extra-icons", "whitespace-icon")
 *
 * The vaadin-iconset element is available in Vaadin 25 as part of
 * @vaadin/icon. No Polymer iron-iconset-svg needed.
 */
