...
public abstract class RuleFormPart extends VerticalLayout {
    ...
    protected DimensionField createSizeField(String label, String key) {
        ...
        binder.forField(field)
                ...
                .withConverter(
                        dimension -> dimension != null ? dimension.toDimensionString() : null,
                        s -> s != null ? new Dimension(s) : null
                )
    ...
    protected static ValueProvider<ObjectNode, String> getter(String key) {
        return jsonObject -> jsonObject.has(key) ? jsonObject.get(key).asText() : null;
    }
    ...
    public void setBean(ObjectNode object) { binder.setBean(object); }
    public ObjectNode getBean() { return binder.getBean(); }
    ...
    public void clearValues() { binder.removeBean(); }
}
