...
public class TablesI18n implements Serializable {
    ...
    public static class TemplatesI18n {
        ...
        public String getTableSectionTitle() { return tableSectionTitle; }
        public void setTableSectionTitle(String tableSectionTitle) { this.tableSectionTitle = tableSectionTitle; }
        public String getSpecialRowsSectionTitle() { return specialRowsSectionTitle; }
        public void setSpecialRowsSectionTitle(String specialRowsSectionTitle) { this.specialRowsSectionTitle = specialRowsSectionTitle; }
        public String getCurrentRowSectionTitle() { return currentRowSectionTitle; }
        public void setCurrentRowSectionTitle(String currentRowSectionTitle) { this.currentRowSectionTitle = currentRowSectionTitle; }
        public String getCurrentColumnSectionTitle() { return currentColumnSectionTitle; }
        public void setCurrentColumnSectionTitle(String currentColumnSectionTitle) { this.currentColumnSectionTitle = currentColumnSectionTitle; }
        public String getSpecialRowsHeaderRowTitle() { return specialRowsHeaderRowTitle; }
        public void setSpecialRowsHeaderRowTitle(String specialRowsHeaderRowTitle) { this.specialRowsHeaderRowTitle = specialRowsHeaderRowTitle; }
        public String getSpecialRowsFooterRowTitle() { return specialRowsFooterRowTitle; }
        public void setSpecialRowsFooterRowTitle(String specialRowsFooterRowTitle) { this.specialRowsFooterRowTitle = specialRowsFooterRowTitle; }
        public String getSpecialRowsEvenRowsTitle() { return specialRowsEvenRowsTitle; }
        public void setSpecialRowsEvenRowsTitle(String specialRowsEvenRowsTitle) { this.specialRowsEvenRowsTitle = specialRowsEvenRowsTitle; }
        public String getSpecialRowsOddRowsTitle() { return specialRowsOddRowsTitle; }
        public void setSpecialRowsOddRowsTitle(String specialRowsOddRowsTitle) { this.specialRowsOddRowsTitle = specialRowsOddRowsTitle; }
        public String getCurrentTemplateSelectFieldLabel() { return currentTemplateSelectFieldLabel; }
        public void setCurrentTemplateSelectFieldLabel(String currentTemplateSelectFieldLabel) { this.currentTemplateSelectFieldLabel = currentTemplateSelectFieldLabel; }
        public String getCurrentTemplateNameFieldLabel() { return currentTemplateNameFieldLabel; }
        public void setCurrentTemplateNameFieldLabel(String currentTemplateNameFieldLabel) { this.currentTemplateNameFieldLabel = currentTemplateNameFieldLabel; }
        public String getCurrentTemplateNameNotUniqueError() { return currentTemplateNameNotUniqueError; }
        public void setCurrentTemplateNameNotUniqueError(String currentTemplateNameNotUniqueError) { this.currentTemplateNameNotUniqueError = currentTemplateNameNotUniqueError; }
        public String getTemplateCopySuffix() { return templateCopySuffix; }
        public void setTemplateCopySuffix(String templateCopySuffix) { this.templateCopySuffix = templateCopySuffix; }
        public String getCreateNewTemplateButtonTooltip() { return createNewTemplateButtonTooltip; }
        public void setCreateNewTemplateButtonTooltip(String createNewTemplateButtonTooltip) { this.createNewTemplateButtonTooltip = createNewTemplateButtonTooltip; }
        public String getCopyTemplateButtonTooltip() { return copyTemplateButtonTooltip; }
        public void setCopyTemplateButtonTooltip(String copyTemplateButtonTooltip) { this.copyTemplateButtonTooltip = copyTemplateButtonTooltip; }
        public String getDeleteTemplateButtonTooltip() { return deleteTemplateButtonTooltip; }
        public void setDeleteTemplateButtonTooltip(String deleteTemplateButtonTooltip) { this.deleteTemplateButtonTooltip = deleteTemplateButtonTooltip; }
        public String getDeleteTemplateConfirmTitle() { return deleteTemplateConfirmTitle; }
        public void setDeleteTemplateConfirmTitle(String deleteTemplateConfirmTitle) { this.deleteTemplateConfirmTitle = deleteTemplateConfirmTitle; }
        public String getDeleteTemplateConfirmText() { return deleteTemplateConfirmText; }
        public void setDeleteTemplateConfirmText(String deleteTemplateConfirmText) { this.deleteTemplateConfirmText = deleteTemplateConfirmText; }
        public String getDeleteTemplateConfirmYesButton() { return deleteTemplateConfirmYesButton; }
        public void setDeleteTemplateConfirmYesButton(String deleteTemplateConfirmYesButton) { this.deleteTemplateConfirmYesButton = deleteTemplateConfirmYesButton; }
        public String getDeleteTemplateConfirmNoButton() { return deleteTemplateConfirmNoButton; }
        public void setDeleteTemplateConfirmNoButton(String deleteTemplateConfirmNoButton) { this.deleteTemplateConfirmNoButton = deleteTemplateConfirmNoButton; }
        public String getFormTableBorderFieldLabel() { return formTableBorderFieldLabel; }
        public void setFormTableBorderFieldLabel(String formTableBorderFieldLabel) { this.formTableBorderFieldLabel = formTableBorderFieldLabel; }
        public String getFormTableCellsBorderFieldLabel() { return formTableCellsBorderFieldLabel; }
        public void setFormTableCellsBorderFieldLabel(String formTableCellsBorderFieldLabel) { this.formTableCellsBorderFieldLabel = formTableCellsBorderFieldLabel; }
        public String getFormBorderFieldLabel() { return formBorderFieldLabel; }
        public void setFormBorderFieldLabel(String formBorderFieldLabel) { this.formBorderFieldLabel = formBorderFieldLabel; }
        public String getFormBorderFieldTooltip() { return formBorderFieldTooltip; }
        public void setFormBorderFieldTooltip(String formBorderFieldTooltip) { this.formBorderFieldTooltip = formBorderFieldTooltip; }
        public String getFormColorFieldTooltip() { return formColorFieldTooltip; }
        public void setFormColorFieldTooltip(String formColorFieldTooltip) { this.formColorFieldTooltip = formColorFieldTooltip; }
        public String getFormTextColorFieldLabel() { return formTextColorFieldLabel; }
        public void setFormTextColorFieldLabel(String formTextColorFieldLabel) { this.formTextColorFieldLabel = formTextColorFieldLabel; }
        public String getFormBackgroundColorFieldLabel() { return formBackgroundColorFieldLabel; }
        public void setFormBackgroundColorFieldLabel(String formBackgroundColorFieldLabel) { this.formBackgroundColorFieldLabel = formBackgroundColorFieldLabel; }
        public String getFormSizeFieldTooltip() { return formSizeFieldTooltip; }
        public void setFormSizeFieldTooltip(String formSizeFieldTooltip) { this.formSizeFieldTooltip = formSizeFieldTooltip; }
        public String getFormNumberFieldLessOrEqualZeroError() { return formNumberFieldLessOrEqualZeroError; }
        public void setFormNumberFieldLessOrEqualZeroError(String formNumberFieldLessOrEqualZeroError) { this.formNumberFieldLessOrEqualZeroError = formNumberFieldLessOrEqualZeroError; }
        public String getFormWidthFieldLabel() { return formWidthFieldLabel; }
        public void setFormWidthFieldLabel(String formWidthFieldLabel) { this.formWidthFieldLabel = formWidthFieldLabel; }
        public String getFormHeightFieldLabel() { return formHeightFieldLabel; }
        public void setFormHeightFieldLabel(String formHeightFieldLabel) { this.formHeightFieldLabel = formHeightFieldLabel; }
    }
}
