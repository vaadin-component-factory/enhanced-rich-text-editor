// Quill 2 / Parchment 3 version of TableTrick
// Changes from V1:
// 1. Parchment.create() -> quill.scroll.create() (static methods get scroll from quill param)
// 2. Parchment.find() -> Quill.find()
...
export default class TableTrick {
  ...
  static insertTable(quill, col_count, row_count, templates) {
    ...
    // Change 1: Parchment.create() -> quill.scroll.create()
  ...
  static removeTable(quill) {
    ...
    if (coords) {
      ...
      // Change 2: Parchment.find() -> Quill.find()
