// Quill 2 / Parchment 3 version of table module index
// Changes from V1:
// 1. Removed vendor import (Quill 2 globally available via RTE 2)
// 2. Keyboard binding keys use string format (Quill 2 uses string keys, not numeric keyCodes)
// 3. Parchment.find() -> Quill.find() in keyboardHandler
...
export default class TableModule {
  ...
  static keyboardHandler(quill, key, range, keycontext) {
    ...
    // Change 3: Parchment.find() -> Quill.find()
